...
_ECHOREQUEST = _descriptor.Descriptor(
    ...
    fields=[_descriptor.FieldDescriptor(name='text',
                                        full_name='test.EchoRequest.text',
                                        index=0,
                                        number=1,
                                        type=9,
                                        cpp_type=9,
...
_ECHORESPONSE = _descriptor.Descriptor(
    ...
    containing_type=None,
    fields=[_descriptor.FieldDescriptor(name='text',
                                        full_name='test.EchoResponse.text',
                                        index=0,
                                        number=1,
                                        type=9,
                                        cpp_type=9,
...
_PINGREQUEST = _descriptor.Descriptor(name='PingRequest',
...
_MATHBINARYOPERATIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[_descriptor.FieldDescriptor(
        name='first',
        full_name='test.MathBinaryOperationRequest.first',
        index=0,
        number=1,
        type=2,
        cpp_type=6,
        ...
        options=None),
            _descriptor.FieldDescriptor(
                name='second',
                full_name='test.MathBinaryOperationRequest.second',
                index=1,
                number=2,
                type=2,
                cpp_type=6,
...
_MATHRESPONSE = _descriptor.Descriptor(
    ...
    file=DESCRIPTOR,
    containing_type=None,
    fields=[_descriptor.FieldDescriptor(name='result',
                                        full_name='test.MathResponse.result',
                                        index=0,
                                        number=1,
                                        type=2,
                                        cpp_type=6,
...
DESCRIPTOR.message_types_by_name['MathBinaryOperationRequest'
                                ] = _MATHBINARYOPERATIONREQUEST
DESCRIPTOR.message_types_by_name['MathResponse'] = _MATHRESPONSE

EchoRequest = _reflection.GeneratedProtocolMessageType('EchoRequest', (
    _message.Message,
), dict(
...
EchoResponse = _reflection.GeneratedProtocolMessageType('EchoResponse', (
    _message.Message,
), dict(
...
PingRequest = _reflection.GeneratedProtocolMessageType('PingRequest', (
    _message.Message,
), dict(
...
PingResponse = _reflection.GeneratedProtocolMessageType('PingResponse', (
    _message.Message,
), dict(
...
MathBinaryOperationRequest = _reflection.GeneratedProtocolMessageType(
    'MathBinaryOperationRequest', (_message.Message,), dict(
...
MathResponse = _reflection.GeneratedProtocolMessageType('MathResponse', (
    _message.Message,
), dict(
...
DESCRIPTOR._options = _descriptor._ParseOptions(
    descriptor_pb2.FileOptions(), _b('\200\001\001\210\001\001\220\001\001'))
...
_TEST = _descriptor.ServiceDescriptor(
    ...
    methods=[_descriptor.MethodDescriptor(name='Ping',
                                          ...
                                          options=None,),
             _descriptor.MethodDescriptor(name='Echo',
...
Test = service_reflection.GeneratedServiceType('Test', (_service.Service,),
                                               dict(DESCRIPTOR=_TEST,
                                                    __module__='test_pb2'))

Test_Stub = service_reflection.GeneratedServiceStubType('Test_Stub', (
    Test,
), dict(DESCRIPTOR=_TEST,
        __module__='test_pb2'))
...
_MATH = _descriptor.ServiceDescriptor(
    ...
    serialized_end=439,
    methods=[
        _descriptor.MethodDescriptor(name='Add',
                                     ...
                                     options=None,),
        _descriptor.MethodDescriptor(name='Multiply',
...
Math = service_reflection.GeneratedServiceType('Math', (_service.Service,),
                                               dict(DESCRIPTOR=_MATH,
                                                    __module__='test_pb2'))

Math_Stub = service_reflection.GeneratedServiceStubType('Math_Stub', (
    Math,
), dict(DESCRIPTOR=_MATH,
        __module__='test_pb2'))  # @@protoc_insertion_point(module_scope)
